...
<section className="carrd card_cont">
    <div className="cardd row align-items-center ">
        <div className="col-md-4 col-sm-12 card-content"  >
         ...
         <h6>Location </h6> 
              <p className="p_colo_r p_colo_cont">Jubail City - the company's headquarters - King Faisal West Road. 6538</p>
  </div>
        <div className="col-md-4 col-sm-12 card-content"  >
          ...
          <div className="login_card">
            ...
            <div className="wave-group">
              ...
              <label className="label">
                ...
                <span className="label-char" style={{'--index': 3}}>j</span>
                <span className="label-char" style={{'--index': 4}}>e</span>
                <span className="label-char" style={{'--index': 5}}>c</span>
                <span className="label-char" style={{'--index': 6}}>t</span>
                <span className="label-char m_n" style={{'--index': 7}}>M</span>
                ...
                <span className="label-char" style={{'--index': 11}}>a</span>
                <span className="label-char" style={{'--index': 12}}>g</span>
                <span className="label-char" style={{'--index': 13}}>e</span>
              </label>
            </div>
            <div className="wave-group">
            <textarea placeholder="  Message" rows="3" name="comment[text]"  id="country" cols="40" className=" w-100" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true"></textarea>
            </div>
