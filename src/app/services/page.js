...
<section className="row about home11 align-items-center flex_direction_column " >
  <div className="col-md-6 col-sm-12">
	...
	<ul><li data-aos="fade-right" data-aos-delay="400">A commercial contract concluded between two parties according to which one of the parties to the contract, who is the trademark owner, grants the other party a license to work according to his trademark, where the benefit is mutual and benefits everyone. Franchise”, so the franchise is valid for a specific period and in certain areas according to the contract concluded.</li></ul>
	<ul className="mt-3"><li data-aos="fade-right" data-aos-delay="600">The work mechanisms are in accordance with the brand policy, internal culture, and its visual identity, and the holder of the right is obliged to comply with that, and the work is carried out based on the “work system regulations” by which the brand is managed, and this follows all branches of the brand around the world, and through it you get a percentage of the profits.
	</li></ul>
  </div>
