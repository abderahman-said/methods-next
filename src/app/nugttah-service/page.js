...
<div className="col-sm-12 col-md-6 ">
  <p data-aos="fade-right" data-aos-delay="0"className="font-reto">OUR SERVICES </p>
  <h2 data-aos="fade-right" data-aos-delay="100">QR Table </h2>
    <p data-aos="fade-right" data-aos-delay="200">The loyalty points feature for cafes is important because it 
     incentivizes customers to return and make repeat offering , café can improve customer 
     retention, increase revenue, and create a positive customer experience. Loyalty points 
     encourage customers to spend more </p>
</div>
<div className="col-sm-12 col-md-6 d-flex justify-content-end align-items-center ">
  <img src="./img/Group 24039.png" alt="" loading="lazy" className="w-100" data-aos="fade-left" />
</div>
</section>
...
<div className="col-sm-12 col-md-6 d-flex justify-content-start align-items-center ">
  <img src="./img/page4.png" alt="" loading="lazy" className="w-100 pt-4"  data-aos="fade-right" />
</div>
<div className="col-sm-12 col-md-6 ">
  <p data-aos="fade-left" data-aos-delay="0"className="font-reto">OUR PRODUCTS</p>
  <h2 data-aos="fade-left" data-aos-delay="100">Our Nugttah App</h2>
...
<img src="./img/line.png" alt="" className="position-fixed resh4   end-0"/>
